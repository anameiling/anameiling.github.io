function GetBookings() {
    let url = 'https://api.sheety.co/2287ba5e9c156f97e011e5cdc03a23cc/studioSessionBookingApp (project)/sheet1';
    fetch(url)
...
function DeleteBooking(id){
    let url = 'https://api.sheety.co/2287ba5e9c156f97e011e5cdc03a23cc/studioSessionBookingApp (project)/bookings/' + id;
    fetch(url, {
        method: 'DELETE',
    })
        .then((response) => {
